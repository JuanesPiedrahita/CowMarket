...
namespace OnSale.Web.Migrations
{
    ...
    [Migration("20201031141644_addComplementCows")]
    partial class addComplementCows
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnSale.Common.Entities.CowImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Common.Entities.Fair", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Web.Data.Entities.Cow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnSale.Common.Entities.CowImage", b =>
                {
                    b.HasOne("OnSale.Web.Data.Entities.Cow")
            ...
            modelBuilder.Entity("OnSale.Web.Data.Entities.Cow", b =>
                {
                    b.HasOne("OnSale.Common.Entities.Fair", "Fair")
                        .WithMany()
                        .HasForeignKey("FairId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OnSale.Web.Data.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("OnSale.Web.Data.Entities.OrderDetail", b =>
                {
                    b.HasOne("OnSale.Web.Data.Entities.Cow", "Cow")
                        .WithMany()
                        .HasForeignKey("CowId");
